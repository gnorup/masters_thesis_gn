# Voice Activity Detector by Jonathan Heitz
# https://github.com/jheitz/luha-prolific-study/blob/main/src/data_analysis/data_transformation/helpers/voice_activity_detector.py
